 ...
 * @constructor
 */
const InMemoryCacheImplementer = function(isConsistentBehaviour) {
  const oThis = this;

  let cacheConfig = oThis.ic().getInstanceFor(coreConstants.icNameSpace, 'getCacheConfigHelper');
...
InMemoryCacheImplementer.prototype = {
  _records: null,
  ...
  increment: function(key, byValue) {
    ...
    return new Promise(async function(onResolve, onReject) {
      ...
      if (!record) {
        ...
        // Set the record
        let setResponse = await oThis.set(key, 0);
